...
python /n/data1/hsph/immid/grad/Kevin/software/pyseer/pyseer-runner.py --phenotypes metadata/gwas-strain-table-filtered.tsv     --phenotype-column CRO_LOG --lmm --output-patterns gwas/results/cro/unitig_patterns.txt     --covariates metadata/gwas-strain-table-filtered.tsv --use-covariates 2     --kmers /n/data1/hsph/immid/grad/gonococcus/analyses/unitigs/2019-04/unitigs/unitigs.txt --uncompressed     --similarity gwas/popstruct/combined_phylogeny_similarity.tsv > gwas/results/cro/pyseer-CRO-cond-country.results.txt 
